    ...
    return (
        <>  
            ...
            <section className="flex-1 flex flex-col gap-4 max-h-[calc(100vh-96px)] relative mt-[80px]">
                <div id="box-1" className="absolute h-1/3 min-h-[200px] ml-[36%] mr-[-10%] mt-[6%] border border-[#262626] rounded-lg z-[1] w-[70%]"></div>
                <div id="box-2" className="absolute h-1/3 min-h-[200px] ml-[12%] border-2 border-[#A9BF9F] mt-[21%] rounded-lg z-[2] w-[85%] flex flex-col items-center justify-center">
