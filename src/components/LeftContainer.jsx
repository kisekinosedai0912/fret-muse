   ...
   return (
        <>  
            <section className="flex-1 flex flex-col gap-4 max-h-[calc(100vh-96px)] relative mt-[80px]">
                <div 
                    id="box-1" 
                    className={`absolute h-1/3 min-h-[200px] ml-[36%] mr-[-10%] mt-[6%] 
                ...
                <div 
                    id="box-2" 
                    className={`absolute h-1/3 min-h-[200px] ml-[12%] border-2 
                ...
                <div 
                    id="box-3" 
                    className={`absolute h-1/3 min-h-[200px] ml-[30%] w-[40%] 
                        mt-[45%] border border-[#262626] rounded-lg z-[3]
